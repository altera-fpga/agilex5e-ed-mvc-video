...
exec -ignorestderr -- $quartus_py build_niosv_sw_sdi.py -d -b
...
post_message "##############################################"
set src_hex [file join src sw sdi_subsys build mem_init nios_sdi_ss_onchip_mem_onchip_mem.hex]
set dst_hex [file join gen vds nios_sdi_ss ip nios_sdi_ss_onchip_mem intel_onchip_memory_200 synth nios_sdi_ss_onchip_mem_onchip_mem.hex]
