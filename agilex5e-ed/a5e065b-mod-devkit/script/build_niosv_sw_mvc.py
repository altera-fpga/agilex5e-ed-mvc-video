...
software_path = script_path.joinpath('../src/sw/vvp_subsys')
software_path_vds = script_path.joinpath('src/sw/vvp_subsys')
...
ELF_NAME="mvc_demo.elf"
HEX_NAME="vvp_pipe_onchip_mem_onchip_mem.hex"

# Application Source Directory
APP_DIR = software_path.joinpath("mvc_demo")
...
# BSP Directory
BSP_DIR = software_path.joinpath("mvc_demo_bsp")
BSP_DIR_VDS = software_path_vds.joinpath("mvc_demo_bsp")
...
BSP_SETTINGS.append(["hal.enable_reduced_device_drivers", "1"])
...
VDS_PATH = script_path.joinpath('src/vds/vvp_pipe', "vvp_pipe.vds")
###############################################################################################################
# Functions
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Build VVP Pipeline Subsystem Software")
