...
exec -ignorestderr -- $quartus_py build_niosv_sw_mvc.py -d -b
...
post_message "##############################################"
set src_hex [file join src sw vvp_subsys build mem_init vvp_pipe_onchip_mem_onchip_mem.hex]
set dst_hex [file join gen vds vvp_pipe ip vvp_pipe_onchip_mem intel_onchip_memory_200 synth vvp_pipe_onchip_mem_onchip_mem.hex]
