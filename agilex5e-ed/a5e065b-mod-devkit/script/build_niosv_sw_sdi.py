...
software_path = script_path.joinpath('../src/sw/sdi_subsys')
software_path_vds = script_path.joinpath('src/sw/sdi_subsys')
...
HEX_NAME="nios_sdi_ss_onchip_mem_onchip_mem.hex"
...
SOPC_TIMER_NAME="nios_sdi_ss_timer"
...
VDS_PATH = script_path.joinpath('src/vds/nios_sdi_ss', "nios_sdi_ss.vds")
###############################################################################################################
# Functions
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Build SDI Subsystem Software")
