...
exec -ignorestderr -- $quartus_py build_niosv_sw_dp.py -d -b
...
post_message "##############################################"
set src_hex [file join src sw dp_subsys build mem_init dp_core_onchip_mem_onchip_mem.hex]
set dst_hex [file join gen vds dp_core ip dp_core_onchip_mem intel_onchip_memory_200 synth dp_core_onchip_mem_onchip_mem.hex]
